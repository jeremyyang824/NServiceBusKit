...
namespace FirstSample.Client
{
    class Program
    {
        ...
        static async Task AsyncMain()
        {
            ...
            Console.Title = "FirstSample.Client";

            // The endpoint name will be used to determine queue names and serves
            // as the address, or identity, of the endpoint
            var endpointConfiguration = new EndpointConfiguration(endpointName: "FirstSample.Client");
        ...
        static async Task SendOrder(IEndpointInstance endpointInstance)
        {
            ...
            while (true)
            {
                ...
                await endpointInstance.Send("FirstSample.Server", placeOrder);
